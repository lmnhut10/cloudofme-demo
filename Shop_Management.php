...
?> 
        ...
        <?php
            ...
            if(isset($_GET["function"])=="del") {
                if(isset($_GET['id'])) {
                    $id = $_GET['id'];
                    pg_query( "DELETE FROM shop WHERE shopid='$id'");
                } 
            }
        ?>
            ...
            <thead>
                <tr>
                    ...
                    <th><strong>shopid</strong></th>
                    <th><strong>shopname</strong></th>
            ...
            <tr>
              ...
              <a href="?page=orderdetail_management&&function=del&&id=<?php echo $row["shopid"]; ?>" onclick="return deleteConfirm()">
